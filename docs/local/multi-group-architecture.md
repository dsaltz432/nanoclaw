...
| Tickets | `tickets` | `tg:-5206776349` | any (no prefix) | **60 min** | Sports ticket price tracking (StubHub) |
...
| tickets | Ticket Pricer | `*/30 * * * *` | **paused** | `task-1775995186831-2hmq79` |
| tickets | Ticket Discovery | `0 10 * * 0` | **paused** | `task-1775995541819-4v6mwl` |
...
| `dashboard/server/routes/tickets.ts:9` | `data/sessions/tickets/.claude/tickets.db` | Events + price snapshots for the Tickets dashboard tab |
